...
//maak connectie met de database
	...
	if(isset($_POST['submit']))
	{
		...
		{ //Tabel informatie
			...
			$sql = "insert into Reis (Boekingsnummer , Titel, Bestemming, Omschrijving, Begindatum, Einddatum, Maxinschrijvingen) values ('$Boekingsnummer','$Titel','$Bestemming','$Omschrijving','$Begindatum','$Einddatum','$Maxinschrijvingen')";
			$rs = mysqli_query($con,$sql);
			
			if(mysqli_affected_rows($con) == 1)
			{
				$lastInsertedID = mysqli_insert_id($con);
				$_SESSION['success_msg'] = 'De reis is succesfol toegevoegd';
...
<div class="topnav">
  ...
  <a href="loginStudent.php">Login als Student</a>
</div>
